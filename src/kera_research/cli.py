...
def build_parser() -> argparse.ArgumentParser:
    ...
    train_parser.add_argument("--crop-mode", default="automated", choices=["automated", "manual", "both", "paired"])
    ...
    cv_parser.add_argument("--crop-mode", default="automated", choices=["automated", "manual", "paired"])
