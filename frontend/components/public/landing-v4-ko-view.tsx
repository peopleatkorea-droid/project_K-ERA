...
const koFeatures = [
  ...
  {
    title: "방문 단위 멀티모달 판독",
    body: "플랫폼은 백색광 · 형광염색 · 세극등 이미지를 함께 저장하고 방문 단위로 검토합니다. 형광염색까지 포함한 멀티모달 입력을 지원하지만, 현재 기본 AI 추론은 제출 논문에서 가장 엄격하게 검증한 백색광 기준으로 운영합니다.",
    chip: "방문 단위",
  ...
  {
    title: "연합학습 확장",
    body: "이미지 단위와 방문 단위의 기관별 학습 라운드, 검토 우선 집계, 서명된 업데이트 검증, privacy budget 보고와 운영 가드레일이 구현돼 있습니다. 유사 증례 검색은 별도의 연합 코퍼스 확장 흐름으로 분리해 운영합니다.",
    chip: "연합학습",
...
const koFaqs = [
  ...
  {
    q: "참여하면 어떤 이점이 있나요?",
    a: "등록한 케이스에 대해 K-ERA AI 추론 결과(신뢰도·GradCAM·앙상블 분석)를 바로 확인할 수 있습니다. DINO 임베딩 기반 유사 증례 검색도 참여 기관에 제공됩니다. 다기관 논문 저자 기준은 ICMJE와 제출 전 서면 기여 합의를 따릅니다.",
  },
  {
    q: "어떤 진단 범주를 지원하나요?",
    a: "현재 공개 벤치마크는 배양검사로 확진된 세균성 각막염(BK)과 진균성 각막염(FK)의 백색광 세극등 이미지 기준입니다. 앱은 백색광 · 형광염색 · 세극등 저장과 방문 단위 검토를 지원하고, 형광염색을 포함한 멀티모달 입력도 연구 흐름에 포함할 수 있습니다. 다만 현재 기본 AI 추론은 제출 논문에서 가장 엄격하게 검증한 백색광 기준으로 운영합니다.",
  },
  {
