  ...
  return (
    <button
      ...
      className={cn(
        ...
        variant === "primary" &&
          "border-brand/18 bg-[linear-gradient(135deg,var(--accent),var(--accent-strong))] text-white [text-shadow:0_1px_1px_rgba(15,23,42,0.28)] shadow-[0_14px_28px_rgba(48,88,255,0.18)] hover:-translate-y-[1px] hover:border-brand-strong hover:shadow-[0_18px_34px_rgba(48,88,255,0.24)] disabled:border-border/70 disabled:bg-surface-muted/82 disabled:[background-image:none] disabled:text-muted disabled:opacity-75 dark:text-[var(--accent-contrast)] dark:[text-shadow:none] dark:disabled:border-white/8 dark:disabled:bg-[rgba(255,255,255,0.12)] dark:disabled:[background-image:none] dark:disabled:text-[rgba(226,232,240,0.78)]",
        variant === "danger" &&
