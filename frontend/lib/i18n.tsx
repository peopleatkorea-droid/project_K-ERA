...
const apiErrorExact = {
  ...
  ko: {
    ...
    "ROI preview record not found.": "ROI 미리보기 기록을 찾을 수 없습니다.",
    "Unknown ROI preview artifact.": "알 수 없는 ROI 미리보기 아티팩트입니다.",
    "Requested ROI artifact is not available.": "요청한 ROI 아티팩트를 사용할 수 없습니다.",
    ...
    "Cross-validation is MedSAM crop-only.": "교차 검증은 MedSAM crop 데이터만 지원합니다.",
    "Initial training is MedSAM crop-only.": "초기 학습은 MedSAM crop 데이터만 지원합니다.",
...
const apiErrorPatterns: Record<Locale, ApiErrorPattern[]> = {
  ...
  ko: [
    ...
    { pattern: /^ROI preview fetch failed: (\d+)$/, render: (code: string) => `ROI 미리보기를 불러오지 못했습니다 (${code}).` },
    ...
    { pattern: /^ROI preview is unavailable: (.+)$/, render: (detail: string) => `ROI 미리보기를 실행할 수 없습니다: ${detail}` },
